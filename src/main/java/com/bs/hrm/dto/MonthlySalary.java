...
public class MonthlySalary {
	...
	public String toString() {
		return "MonthlySalary [employeeId=" + employeeId + ", year=" + year + ", month=" + month + ", monthStr="
				+ monthStr + ", employeeType=" + employeeType + ", basicSalary=" + basicSalary + ", overtimeAmount="
				+ overtimeAmount + ", allowance=" + allowance + ", totalSalary=" + totalSalary + ", loanDeduction="
				+ loanDeduction + ", netSalary=" + netSalary + ", salaryDate=" + salaryDate + ", departmentId="
				+ departmentId + ", filler1=" + filler1 + ", filler2=" + filler2 + ", filler3=" + filler3 + ", filler4="
				+ filler4 + ", filler5=" + filler5 + ", filler6=" + filler6 + ", filler7=" + filler7 + ", filler8="
				+ filler8 + ", filler9=" + filler9 + ", filler10=" + filler10 + ", filler11=" + filler11 + ", filler12="
				+ filler12 + ", filler13=" + filler13 + ", filler14=" + filler14 + ", filler15=" + filler15
				+ ", filler16=" + filler16 + ", filler17=" + filler17 + ", filler18=" + filler18 + ", filler19="
				+ filler19 + ", filler20=" + filler20 + ", createdDate=" + createdDate + ", updatedDate=" + updatedDate
				+ ", createdBy=" + createdBy + ", createdIp=" + createdIp + ", updatedBy=" + updatedBy + ", updatedIp="
				+ updatedIp + "]";
	}
