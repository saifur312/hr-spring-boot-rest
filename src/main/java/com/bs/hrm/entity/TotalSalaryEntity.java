...
@IdClass(TotalSalaryEntityId.class)
@NoArgsConstructor
@AllArgsConstructor
//@RequiredArgsConstructor
@Data
public class TotalSalaryEntity {
	@Id
	...
	public String toString() {
		return "TotalSalaryEntity [year=" + year + ", month=" + month + ", employeeType=" + employeeType
				+ ", basicSalary=" + basicSalary + ", overtimeAmount=" + overtimeAmount + ", allowance=" + allowance
				+ ", totalSalary=" + totalSalary + ", loanDeduction=" + loanDeduction + ", netSalary=" + netSalary
				+ ", salaryDate=" + salaryDate + ", departmentId=" + departmentId + ", filler1=" + filler1
